...
async function createDetector() {
    const barcodeDetector = barcodeDetectorPolyfill.BarcodeDetectorPolyfill
    supportedFormats = await barcodeDetector.getSupportedFormats()
    el.formats.innerHTML = supportedFormats.join(', ')
    detector = new barcodeDetector({ formats: supportedFormats, zbar: { encoding: el.encoding.value } })
}
